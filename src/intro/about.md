...
There's a [last section on the end of the Rust learning content](/appendix/appendix-vi-more-material.md).
...
In case you are a Python or Javascript developer you might find the [Appendix V. Python / Javascript developers](/appendix/appendix-v-python--javascript-developers.md) section useful.
